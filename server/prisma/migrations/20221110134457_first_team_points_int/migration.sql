...
INSERT INTO "new_Guess" ("create", "firstTeamPoints", "gameId", "id", "participantId", "secondTeamPoints") SELECT "create", "firstTeamPoints", "gameId", "id", "participantId", "secondTeamPoints" FROM "Guess";
DROP TABLE "Guess";
