  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center '>
      <main>
        ...
        <h1 className='mt-12 text-white text-5xl font-bold leading-tight'>Crie seu próprio bolão da copa e compartilhe com seus amigos!</h1>
        ...
        <div className='mt-10 pt-18 border-t border-gray-600 flex items-center justify-between text-gray-100'>
      ...
      <Image src={appimg} alt="imagem celular" quality={100} />
    </div>
  )
}
